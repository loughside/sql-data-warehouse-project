...
Script Purpose:
  ...
  It performs the following actions:
    ...
    - Uses the `INSERT INTO` command to load cleaned data from bronze tables to silver tables.
...
-- Stored Procedure for extracting data from the source systems into the Silver layer
